        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {skills.map((skill, index) => (
            <FadeUp key={skill} delay={index * 0.04}>
              <CardSpotlight className="group rounded-xl border border-border bg-surface p-5 shadow-sm transition-all duration-300 hover:border-primary/20 hover:shadow-md">
